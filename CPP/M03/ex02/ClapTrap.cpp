...
ClapTrap::ClapTrap() : _name("no_name"),_hit(100), _energy(100), _attack_damage(30){
    std::cout << "ClapTrap Constructor" << std::endl;
}

ClapTrap::ClapTrap(std::string name) :  _name(name), _hit(100), _energy(100), _attack_damage(30){
